...
# (https://github.com/DevliegereM/jamf-html-reports). The layout, colour
...
class HtmlReport:
    ...
    The report mirrors the structure pioneered by DevliegereM's jamf-html-reports
    ...
    def _css(self) -> str:
        ...
        (github.com/DevliegereM/jamf-html-reports) with minor modifications for
...
<div class="page">
  ...
  <div class="footer">
    ...
    <a href="https://github.com/DevliegereM/jamf-html-reports" target="_blank">
      DevliegereM/jamf-html-reports
    </a>
  </div>
