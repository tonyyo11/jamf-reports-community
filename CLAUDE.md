...
(removed on landing, outside the manifest), and appends ` — cause: … — hint: …` (each part
only when known) to the Run History warning line. `isCollectDead` asks whether any kind
landed, not whether any exited 0.
